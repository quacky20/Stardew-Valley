...
class Plant(pygame.sprite.Sprite):
    def __init__(self, groups, plant_type, soil, check_watered):
        ...
        self.frames = import_folder('graphics', 'fruit', plant_type)
        self.soil = soil
        ...
        self.rect = self.image.get_frect(midbottom = self.soil.rect.midbottom + pygame.math.Vector2(0, self.y_offset))
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):       
        ...
        self.soil_water_surfs = import_folder('graphics', 'soil_water')
        ...
        for soil_sprite in self.soil_sprites.sprites():
            if soil_sprite.rect.collidepoint(target_pos):
                ...
                if 'W' not in self.grid[y][x]:
                    ...
                    WaterTile((self.all_sprites, self.soil_water_sprites), soil_sprite.rect.topleft, choice(self.soil_water_surfs))
        ...
        for index_row, row in enumerate(self.grid):
            for index_col, cell in enumerate(row):
                if 'X' in cell and 'W' not in cell:
                    ...
                    x = index_col * TILE_SIZE
                    y = index_row * TILE_SIZE
                    WaterTile((self.all_sprites, self.soil_water_sprites), (x,y), choice(self.soil_water_surfs))
        ...
        for index_row, row in enumerate(self.grid):
            for index_col, cell in enumerate(row):
                if 'X' in cell:
                    ...
                    SoilTile((self.all_sprites, self.soil_sprites), (index_col * TILE_SIZE, index_row * TILE_SIZE), self.soil_surfs[tile_type])